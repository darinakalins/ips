...
/// функция PrintMatrix() печатает элементы матрицы matrix на консоль;
/// numb_rows - количество строк в исходной матрице matrix
/// numb_cols - количество столбцов в исходной матрице matrix
...
/// функция FindAverageValues() находит средние значени¤ в матрице matrix
/// по строкам, либо по столбцам в зависимости от значени¤ параметра proc_type;
/// proc_type - признак, в зависимости от которого средние значени¤ вычисл¤ютс¤ 
/// либо по строкам, либо по стобцам исходной матрицы matrix
...
/// функция PrintAverageVals() печатает элементы массива average_vals на консоль;
...
/// dimension - количество элементов в исходной массиве average_vals
